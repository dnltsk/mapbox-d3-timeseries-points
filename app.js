...
let renderStations = () => {
  stations
      .attr("cx", function(station, i){return projectLonLatToMapbox(station.coord)[0]})
      .attr("cy", function(station, i){return projectLonLatToMapbox(station.coord)[1]})
      .style("fill", function(station, i){return colorTable(station)})
      .attr("r", 5);
};
